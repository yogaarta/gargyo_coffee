...
const getSingleUserFromServer = (id) => {
    return new Promise((resolve, reject) => {
        const sqlQuery = "select id, email, mobile_number, display_name, first_name, last_name, address, to_char(birthday, 'YYYY-MM-DD') as birthday, gender, profile_picture, roles from users where id = $1";
